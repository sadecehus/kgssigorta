      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center bg-white rounded-lg p-6 shadow-md border border-gray-100">
              <TrendingUp className="w-8 h-8 text-[#0a2d5f] mx-auto mb-2" />
              <div className="text-3xl font-bold text-[#0a2d5f]">15+</div>
            ...
            <Card className="shadow-xl border border-gray-200">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-[#0a2d5f] hover:bg-[#1e3a8a] text-lg py-3 rounded-lg">
                    Teklif Talep Et
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
                </form>
